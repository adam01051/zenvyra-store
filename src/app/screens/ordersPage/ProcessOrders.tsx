...
const processOdersRetriever = createSelector(
...
export default function ProcessOrders(props: ProcessOrdersProps) {
	const { processOrders } = useSelector(processOdersRetriever);
					...
					return (
						<Box key={order._id} className={"order-main-box"}>
							...
							<Box className={"total-price-box"}>
								...
								<Button value={ order._id} onClick={finishedOrderHandler} variant="contained" className={"verify-button"}>
									Verify to Fulfil
								</Button>
							</Box>
						</Box>
