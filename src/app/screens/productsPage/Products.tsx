          ...
          <Stack className={"list-category-section"}>
            ...
            <div className="category-main">
              ...
              <Button
                ...
                className={"order"}
                onClick={() =>
                  searchCollectionHandler(ProductCollection.HOODIE)
                }
              >
                HOODIE
              </Button>
              ...
              <Button
                ...
                className={"order"}
                onClick={() =>
                  searchCollectionHandler(ProductCollection.JACKET)
                }
              >
                JACKET
              </Button>
                ...
                products.map((product: Product) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Box className={"product-desc"} sx={{ color: "gray" }}>
                    
                        <span className={"product-title"}style={{padding:"5px"}}>
                          {product.productName}
                        </span> 
                        <Box className="product-meta">
                          ...
                          <Box className="meta-row">
                            ...
                            <span className="product-view" style={{marginLeft:"125px"}} >
                              <RemoveRedEyeIcon />
                          ...
                          <Box className="meta-row">
                            <div className="product-price">
                              ...
                              <MonetizationOnIcon />
							    ...
							    <span  style={{marginLeft:"165px"}}>${product.productPrice}</span>
